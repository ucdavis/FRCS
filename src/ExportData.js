  ...
  const makeExcel = async () => {
    ...
    worksheet.addTable({
      ...
      rows: [
        ...
        [
          ...
          input.includeCostsCollectChipResidues ? "Yes" : "No",
        ],
        ["Include move-in costs?", input.includeMoveInCosts ? "Yes" : "No"],
        ["Area Treated (acres)", input.includeMoveInCosts ? input.area : "NA"],
        [
          "One Way Move In Distance (miles)",
          input.includeMoveInCosts ? input.moveInDistance : "NA",
        ],
    ...
    worksheet.addTable({
      ...
      columns: [
        ...
        { name: "Trees/acre" },
        { name: "Vol/tree (ft3)" },
        { name: "Green Wood Density (lbs/cf)" },
        { name: "Residue Fraction" },
        { name: "Hardwood Fraction" },
      ],
      rows: [
        [
          "Chip Trees",
    ...
    worksheet.addTable({
      ...
      columns: [
        ...
        { name: "Cost ($/GT)" },
        { name: "Diesel (gal/ac)" },
        { name: "Gasoline (gal/ac)" },
        { name: "Jet Fuel (gal/ac)" },
      ],
      rows: [
        [
          "Total",
